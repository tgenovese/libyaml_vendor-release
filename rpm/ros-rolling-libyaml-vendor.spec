...
%description
Wrapper around libyaml, provides the last version (1.8.0 rc) that ships with a
CMake module
...
%changelog
* Thu Jan 28 2021 Michel Hidalgo <michel@ekumenlabs.com> - 1.1.0-1
- Autogenerated by Bloom

* Wed Jan 20 2021 Mikael Arguedas <mikael@osrfoundation.org> - 1.0.2-2
- Autogenerated by Bloom
